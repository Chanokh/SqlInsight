...
def analizza(sessione: Session, elemento: File, codifica: str) -> None:
    ...
    try:
        ...
        # Iterando su ciascun elemento dei dati strutturati si ottengono istanze di Token
        # Tutti i token possibili sono definiti in sqlparse.tokens. La classe base Token
        # utilizza la tecnica della sovrascrittura di __getattr__ per creare nuovi membri
        # e in definitiva nuovi token. Il token è una unità sintattica.
